...
<div class="right-contain-home-box">
        ...
        <div class="right-contain-home-box-elements">
            <h2 style="border-bottom:none;padding-bottom:0px;">Tv-show</h2>
...
<script>
    ...
    $("li").removeClass("selected-nav-li");
        $("#tv-show-nav-li").addClass("selected-nav-li");
    $("#tv-show-nav-li"). prop('onclick',null);
